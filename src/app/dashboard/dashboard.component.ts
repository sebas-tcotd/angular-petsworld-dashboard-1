...
import { UniversalService } from "app/services/universal.service";
...
export class DashboardComponent implements OnInit {
  ...
  setState() {
    this.universalService
      .getusers()
      .subscribe((res) => (this.ViewModel["users"] = res));
    this.universalService
      .getReports()
      .subscribe((res) => (this.ViewModel["reports"] = res));
    this.universalService
      .getPets()
      .subscribe((res) => (this.ViewModel["pets"] = res));
